...
public class PhonebookController {
    ...
    public void removeContact() {
        ...
        try {
            ...
            System.out.println("Problem deleting contact: " + exception.getClass() + exception.getMessage());
        }
    }
    ...
    public void findContact() {
        System.out.println("Enter the name or number to find:");
        String contactToFind = scanner.nextLine();

        ArrayList<Contact> foundContacts = new ArrayList<>();

        for (Contact contact: this.contacts){
            if (contact.toString().toLowerCase().trim().contains(contactToFind.trim().toLowerCase())){
        ...
        this.showAllContacts(foundContacts);
    }
}
